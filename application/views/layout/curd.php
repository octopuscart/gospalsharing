    ...
    <div class="container-fluid">
        ...
        <div id="content" class="content">
            ...
            <div id="content" class="content">
                ...
                <!-- end breadcrumb -->
                <!-- begin page-header -->
                <h1 class="page-header"><?php echo $title; ?> <small><?php $description; ?></small>
                    <?php if ($form_title) { ?>
                        <button type="button" class="btn btn-primary p-l-40 p-r-40" style='float:right' data-toggle="modal" data-target="#add_item"><i class="fa fa-plus"></i> Add New</button>
                        <?php
                    }
                    ?>
                </h1>
